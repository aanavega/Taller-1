...
[![](<a href='https://postimg.cc/6yP3t3fh' target='_blank'><img src='https://i.postimg.cc/6yP3t3fh/Whats-App-Image-2024-03-10-at-07-54-15.jpg' border='0' alt='Whats-App-Image-2024-03-10-at-07-54-15'/></a>)](<a href='https://postimg.cc/6yP3t3fh' target='_blank'><img src='https://i.postimg.cc/6yP3t3fh/Whats-App-Image-2024-03-10-at-07-54-15.jpg' border='0' alt='Whats-App-Image-2024-03-10-at-07-54-15'/></a>) 
 ...
 ## Segundo punto
 - Explicacion:
   1) Definimos las variables, tres numeros reales (float).
   2) Indicamos los condicionales para ver cual numero es mayor.
   3) Hacemos los tres casos, en los que, el primer numero es el mayor, en el que el segundo es el mayor, y por ultimo, en el que el tercero es el mayor.
 ...
 ## Tercer punto
 - Explicacion:
   1) Definimos las variables, en este caso, un numero n entero (int).
   2) Si el residuo de n entre 2 es 0.
   3) Si no es 0, es impar.

 ## Cuarto punto
 - Explicacion:
   1) Definimos las variables, tres numeros reales (float).
   2) Hacemos un condicional para ver si el residuo del primer numero entre el segundo es 0.
   3) Si es 0, si es multiplo, si no, no es multiplo del segundo numero
  
 ## Quinto punto
 - Explicacion:
   1) Definimos las variables, tres numero reales (float).
   2) Hacemos una serie de condicionales para ver si la suma del primer numero con el segundo es mayor, menor, o igual al tercero.

 ## Sexto punto
 - Explicacion:
   1) Definimos dos conjuntos, conjunto vocales, conjunto consonantes y los elementos que los componen.
   2) Definimos una variable x.
   3) Evaluamos si la variable x se encuentra en el conjunto vocales.
   4) Si si, x es una vocal. Si no, no es una vocal.
